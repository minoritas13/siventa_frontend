  ...
  return (
    <footer className="bg-[#C4161C] text-white py-8 px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 items-start gap-10">
        ...
        {/* Kolom 2: Informasi Alamat & Website (Tengah) */}
        <div className="flex flex-col space-y-4 text-[13px] leading-relaxed">
          {/* Alamat kantor menggunakan font-normal agar tetap bersih */}
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              ...
              <a 
                href="https://lampung.antaranews.com" 
                target="_blank" 
                rel="noreferrer" 
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="font-normal">antarabirolampung</span>
            </div>
          </div>
        </div>

        {/* Kolom 3: Kontak & Media Sosial (Rata Kanan) */}
        <div className="flex flex-col space-y-2 text-[13px] md:items-end">
          <div className="flex items-center gap-3">
            <FaPhoneAlt />
            <span className="font-normal">0721 482001</span>
          </div>
          <div className="flex items-center gap-3">
            <FaEnvelope />
            <span className="font-normal">antaralampung@gmail.com</span>
          </div>
          <div className="flex items-center gap-3">
            <FaFacebook />
            <span className="font-normal">antaralampung</span>
          </div>
          <div className="flex items-center gap-3">
            <FaXTwitter />
            <span className="font-normal">antaralampung</span>
