...
function LandingPage() {
  // Reusable Card Component untuk konsistensi desain
  const Card = ({ children }) => (
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-6 py-12 max-w-7xl mx-auto font-sans">
        <div className="md:w-1/2 space-y-6">
          ...
          <div className="flex space-x-4 pt-4">
            <button className="bg-[#C4161C] text-white px-6 py-3 rounded-md font-medium flex items-center hover:bg-[#AA1419] transition">
              Pelajari Lebih Lanjut <span className="ml-2">↓</span>
            </button>
            <button className="border border-gray-300 text-gray-700 px-8 py-3 rounded-md font-medium hover:bg-gray-50 transition">
              Hubungi Admin
            </button>
          </div>
        </div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-16 space-y-24">
        ...
        <section id="tentang" className="text-center">
          <h2 className="text-2xl font-medium mb-4 flex justify-center items-center gap-2">
            <span>Tentang</span>
            <span className="flex">
          ...
          <div className="max-w-4xl mx-auto">
            <Card>
              <ul className="text-sm text-gray-600 space-y-3 text-left list-disc list-outside ml-5">
                <li>
                  <span className="font-medium">Dashboard Informasi</span>, untuk
                  menampilkan ringkasan kondisi inventaris secara real-time.
                </li>
                <li>
                  <span className="font-medium">Manajemen Data Barang</span>, untuk
                ...
                <li>
                  <span className="font-medium">Laporan Inventaris</span>, yang
                  dapat diakses oleh pihak berwenang untuk kebutuhan monitoring
                  dan evaluasi.
                </li>
                <li>
                  <span className="font-medium">Manajemen Pengguna</span>, dengan
