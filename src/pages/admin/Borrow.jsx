...
import { Search, Download, Clock, AlertCircle, Check, X, Eye, History, ClipboardPlus, } from "lucide-react";
      ...
      <main className="flex-1 p-4 md:p-10 pt-20 md:pt-10 overflow-x-hidden">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="flex border-b border-gray-100 px-4 md:px-6 pt-4 gap-6 md:gap-8 overflow-x-auto scrollbar-hide">
            <button
              onClick={() => { setActiveTab("pengajuan"); setSearch(""); }}
                ...
                {filteredLoans.length > 0 ? (
                  filteredLoans.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <p className="text-xs font-medium text-gray-700 uppercase">{item.barang}</p>
                      </td>
